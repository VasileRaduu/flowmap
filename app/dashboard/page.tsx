...
import { Filter, Grid3x3Icon, List, Loader2, Plus, PlusIcon, Rocket, Search, Trello } from "lucide-react";
	...
	{/* SEARCH BAR */}
		...
		<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 sm:gap-6">
			...
			<Link href={`/boards/${board.id}`} key={key}>
				<Card className="hover:shadow-lg transition-shadow cursor-pointer group">
					...
					<CardContent className="pd-4 sm:p-6">
		...
		<Card className="border-2 border-dashed border-gray-300 hover:border-blue-400 transition-colors cursor-pointer group">
			<CardContent className="p-4 sm:p-6 flex items-center justify-center h-full min-h-[200px]">
				...
				<p className="text-sm sm:text-base text-gray-600 group-hover:text-blue-600 font-meium">Create new board</p>
			</CardContent>
		</Card>
		</div>
		) : (
